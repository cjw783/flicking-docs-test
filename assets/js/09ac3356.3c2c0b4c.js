"use strict";(self.webpackChunkdocs=self.webpackChunkdocs||[]).push([["9270"],{32619(e,i,n){n.r(i),n.d(i,{metadata:()=>l,default:()=>m,frontMatter:()=>o,contentTitle:()=>r,toc:()=>u,assets:()=>h});var l=JSON.parse('{"id":"demos/basic/input-type","title":"Input Type","description":"inputType \uC635\uC158\uC73C\uB85C \uD65C\uC131\uD654\uD560 \uC785\uB825 \uC7A5\uCE58 \uD0C0\uC785\uC744 \uC124\uC815\uD569\uB2C8\uB2E4","source":"@site/docs/demos/basic/input-type.mdx","sourceDirName":"demos/basic","slug":"/demos/basic/input-type","permalink":"/flicking-docs-test/docs/demos/basic/input-type","draft":false,"unlisted":false,"editUrl":"https://github.com/naver/egjs-flicking/edit/master/docs/docs/demos/basic/input-type.mdx","tags":[],"version":"current","sidebarPosition":12,"frontMatter":{"title":"Input Type","id":"input-type","slug":"/demos/basic/input-type","sidebar_position":12,"description":"inputType \uC635\uC158\uC73C\uB85C \uD65C\uC131\uD654\uD560 \uC785\uB825 \uC7A5\uCE58 \uD0C0\uC785\uC744 \uC124\uC815\uD569\uB2C8\uB2E4","keywords":["flicking","carousel","inputType","touch","mouse","\uC785\uB825","\uD130\uCE58","\uB9C8\uC6B0\uC2A4"]},"sidebar":"demosSidebar","previous":{"title":"Threshold","permalink":"/flicking-docs-test/docs/demos/basic/threshold"},"next":{"title":"Disable Input","permalink":"/flicking-docs-test/docs/demos/basic/disable-input"}}'),s=n(65723),t=n(54187),c=n(27449),a=n(72722);n(22155);let d=`
.flicking-panel {
  width: 50%;
  height: 120px;
}
...
}`:""})`)});`:"",f=[...c.map(e=>[`{ ${e[0]} }`,"@egjs/flicking-plugins"]),...h],x=Object.keys(n).map(e=>{let i=n[e];return`flicking.on("${e}", ${i})
`}).join(""),k=i.filter(e=>e.isSlot);return(0,l.jsxs)(l.Fragment,{children:[(0,l.jsx)(s.A,{className:"language-html",title:"html",children:`<div id="flick" class="flicking-viewport${u&&` ${u}`}${!1===e.horizontal?" vertical":""}">
  ...
  ${k.map(e=>`<${e.tag}${d(e)}${p(e)}>${e.content}</${e.tag}>`).join("\n  ")}`:""}
</div>${o?"\n"+o.map(e=>`<${e.tag}${d(e)}${p(e)}>${e.content}</${e.tag}>`).join("\n"):""}`}),(0,l.jsx)(s.A,{className:"language-js",title:"js",children:`${r(f)}

${m}${v}${j}${x}`.trim()})]})},g=({options:e,panels:i,events:n={},methods:t={},plugins:c,siblings:a,imports:o=[],viewportClass:u=""})=>{let g=c?`
...
const ${e} = ${t[e]};`).join("");j&&(j+="\n"),c&&v.push([`{ ${c.map(e=>e[0])} }`,"@egjs/flicking-plugins"]),v.push(...o);let f=m.length?`
      ...
      </ViewportSlot>`:"",x=Object.keys(n).map(e=>` on${e[0].toUpperCase()+e.slice(1)}={${n[e]}}`).join("");return(0,l.jsx)(s.A,{className:"language-jsx",title:"DemoComponent.jsx",children:`${r(v,{includeFlicking:!1})}
${j}
export default class DemoComponent extends Component {${g}
  public render() {
    return ${a?"<>\n    ":""}<Flicking${u&&` className="${u}"`}${e?` ${Object.keys(e).map(i=>`${i}=${"string"==typeof e[i]?`"${e[i]}"`:`{${e[i]}}`}`).join(" ")}`:""}${c?" plugins={this._plugins}":""}${x}>
...
}`})},m=({options:e,panels:i,events:n={},methods:t={},plugins:c,siblings:a=[],imports:u=[],viewportClass:g=""})=>{let m=o(e),v=i.filter(e=>e.isSlot),j=c?`,
  data() {
    return {
      plugins: [${h(c)}]
    }
  ...
  </template>`:"",x=[...(c??[]).map(e=>[`{ ${e[0]} }`,"@egjs/flicking-plugins"]),...u],k=Object.keys(t),$=k.length>0?`,
  methods: {
    ${k.map(e=>`${e}: ${t[e].split("\n").map((e,i)=>i>0?`    ${e}`:e).join("\n")}`).join(",\n")}
  }`:"",y=Object.keys(n).map(e=>` @${e.replace(/([A-Z])/g,"-$1").toLowerCase()}="${n[e]}"`).join("");return(0,l.jsxs)(l.Fragment,{children:[(0,l.jsx)(s.A,{className:"language-html",title:"template",children:`<Flicking${g&&` class="${g}"`}${e?` :options="{ ${m} }"`:""}${c?' :plugins="plugins"':""}${y}>
  ${i.filter(e=>!e.isSlot).map(e=>`<${e.tag}${d(e)}${p(e)}>${e.content}</${e.tag}>`).join("\n  ")}${f}
</Flicking>${a?`
${a.map(e=>`<${e.tag}${d(e)}${p(e)}>${e.content}</${e.tag}>`).join("\n")}`:""}`}),(0,l.jsx)(s.A,{className:"language-js",title:"script",children:`${r(x,{prefix:"vue3"})}

export default {
  components: {
    Flicking
  }${j}${$}
}`})]})},v=({js:e,react:i,vue3:n,style:a,...d})=>(0,l.jsxs)("div",{children:[(0,l.jsxs)(c.A,{groupId:"cfc",defaultValue:"js",children:[(0,l.jsx)(t.A,{value:"react",label:"React",children:i||(0,l.jsx)(g,{...d})}),(0,l.jsx)(t.A,{value:"vue3",label:"Vue@3",children:n||(0,l.jsx)(m,{...d})}),(0,l.jsx)(t.A,{value:"js",label:"JavaScript",children:e||(0,l.jsx)(u,{...d})})]}),a&&(0,l.jsx)(s.A,{className:"language-css",title:"style",children:`${a}`})]})}}]);