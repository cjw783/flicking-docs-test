"use strict";(self.webpackChunkdocs=self.webpackChunkdocs||[]).push([["7242"],{62398(e,i,s){s.r(i),s.d(i,{metadata:()=>t,default:()=>x,frontMatter:()=>a,contentTitle:()=>u,toc:()=>h,assets:()=>p});var t=JSON.parse('{"id":"demos/advanced/resize-optimization","title":"Resize Optimization","description":"\uB9AC\uC0AC\uC774\uC988 \uAD00\uB828 \uC635\uC158 \uC870\uD569\uC73C\uB85C \uD06C\uAE30 \uBCC0\uACBD \uAC10\uC9C0\uC640 \uC131\uB2A5\uC744 \uCD5C\uC801\uD654\uD569\uB2C8\uB2E4","source":"@site/docs/demos/advanced/resize-optimization.mdx","sourceDirName":"demos/advanced","slug":"/demos/advanced/resize-optimization","permalink":"/flicking-docs-test/docs/demos/advanced/resize-optimization","draft":false,"unlisted":false,"editUrl":"https://github.com/naver/egjs-flicking/edit/master/docs/docs/demos/advanced/resize-optimization.mdx","tags":[],"version":"current","sidebarPosition":7,"frontMatter":{"title":"Resize Optimization","id":"resize-optimization","slug":"/demos/advanced/resize-optimization","sidebar_position":7,"description":"\uB9AC\uC0AC\uC774\uC988 \uAD00\uB828 \uC635\uC158 \uC870\uD569\uC73C\uB85C \uD06C\uAE30 \uBCC0\uACBD \uAC10\uC9C0\uC640 \uC131\uB2A5\uC744 \uCD5C\uC801\uD654\uD569\uB2C8\uB2E4","keywords":["flicking","carousel","resize","autoResize","resizeDebounce","ResizeObserver","\uC131\uB2A5"]},"sidebar":"demosSidebar","previous":{"title":"Lazy Load","permalink":"/flicking-docs-test/docs/demos/advanced/lazy-load"},"next":{"title":"Add / Remove","permalink":"/flicking-docs-test/docs/demos/advanced/add-remove"}}'),n=s(65723),c=s(54187),r=s(27449),o=s(72722);s(22155);let l=`
.flicking-panel {
  width: 200px;
  height: 150px;
  margin-right: 10px;
...
${u}`:d},...a},"react"===s?{"/App.tsx":{code:e},"/index.js":{code:l,hidden:!0},...x}:"vue3"===s?{"/src/App.vue":{code:e},...x}:{"/src/index.js":{code:e},"/index.js":{code:function(e){let i=e.split("\n"),s=[],t=[],n=!1;for(let e of i)n?t.push(e):e.trimStart().startsWith("import ")||""===e.trim()?s.push(e.replace('"../styles.css"','"./styles.css"')):(n=!0,t.push(e));for(;t.length>0&&""===t[t.length-1].trim();)t.pop();return[...s,"","const _run = () => {",...t.map(e=>`  ${e}`),'  document.querySelectorAll(".flicking-viewport").forEach(el => { el.style.opacity = "1"; });',"};","",'if (document.readyState === "loading") {','  document.addEventListener("DOMContentLoaded", _run);',"} else {","  _run();","}"].join("\n")}(e),hidden:!0},"/styles.css":{code:g},"/index.html":{code:(h="<style>.flicking-viewport{opacity:0}</style>",(p=i||o).includes("</head>")?p.replace("</head>",`${h}
</head>`):h+p)},...a}),customSetup:{dependencies:{...r[s],...c}},options:{showLineNumbers:!0,editorHeight:400,externalResources:[],visibleFiles:"react"===s?["/App.tsx","/styles.css"]:"vue3"===s?["/src/App.vue","/styles.css"]:["/src/index.js","/index.html","/styles.css"],activeFile:"react"===s?"/App.tsx":"vue3"===s?"/src/App.vue":"/src/index.js"}})}},72722(e,i,s){s.d(i,{A:()=>m});var t=s(65723),n=s(34622),c=s(7210),r=s(78863);s(22155);let o=(e,i='"')=>"string"==typeof e?`${i}${e}${i}`:e,l=(e,i="class")=>e.class?` ${i}="${e.class}"`:"",d=(e,i=!1)=>e.style?i?` style={{ ${Object.keys(e.style).map(i=>`${i}: ${o(e.style[i])}`).join(", ")} }}`:` style="${Object.keys(e.style).map(i=>`${i}: ${e.style[i]};`).join(" ")}"`:"",a=e=>`${Object.keys(e).map(i=>`${i}: ${o(e[i],"'")}`).join(", ")}`,u=(e,{prefix:i,includeFlicking:s=!0}={})=>{let t=s?[["Flicking",`@egjs/${i?`${i}-`:""}flicking`]]:[];return e&&t.push(...e),`${t.map(e=>Array.isArray(e)?`import ${e[0]} from "${e[1]}";`:`import "${e}";`).join("\n")}`},p=e=>`${e.map(e=>`new ${e[0]}(${"object"==typeof e[1]?`{ ${a(e[1])} }`:e[1]??""}`).join(", ")})`,h=({options:e,panels:i,events:s={},methods:c={},plugins:r=[],siblings:a=[],imports:p=[],viewportClass:h=""})=>{let g=e=>`${Object.keys(e).map(i=>`${i}: ${o(e[i])}`).join(",\n  ")}`,x=Object.keys(c).map(e=>`const ${e} = ${c[e]};
`).join(""),m=e?`const flicking = new Flicking("#flick", {
  ${g(e)}
});

`:'const flicking = new Flicking("#flick")',z=r.length>0?`flicking.addPlugins(${r.map(e=>`new ${e[0]}(${e[1]?`{
  ${"object"==typeof e[1]?g(e[1]):e[1]??""}
}`:""})`)});`:"",j=[...r.map(e=>[`{ ${e[0]} }`,"@egjs/flicking-plugins"]),...p],b=Object.keys(s).map(e=>{let i=s[e];return`flicking.on("${e}", ${i})
...
${x}${m}${z}${b}`.trim()})]})},g=({options:e,panels:i,events:s={},methods:c={},plugins:r,siblings:o,imports:a=[],viewportClass:h=""})=>{let g=r?`
  private _plugins = [${p(r)}];
...
const ${e} = ${c[e]};`).join("");z&&(z+="\n"),r&&m.push([`{ ${r.map(e=>e[0])} }`,"@egjs/flicking-plugins"]),m.push(...a);let j=x.length?`
      <ViewportSlot>
...
export default class DemoComponent extends Component {${g}
  public render() {
    return ${o?"<>\n    ":""}<Flicking${h&&` className="${h}"`}${e?` ${Object.keys(e).map(i=>`${i}=${"string"==typeof e[i]?`"${e[i]}"`:`{${e[i]}}`}`).join(" ")}`:""}${r?" plugins={this._plugins}":""}${b}>
      ${i.filter(e=>!e.isSlot).map(e=>`<${e.tag}${l(e,"className")}${d(e,!0)}>${e.content.replace(/class/g,"className")}</${e.tag}>`).join("\n      ")}${j}
    </Flicking>${o?`
    ${o.map(e=>`<${e.tag}${l(e,"className")}${d(e,!0)}>${e.content.replace(/class/g,"className")}</${e.tag}>`).join("\n    ")}
    </>`:""};
  }
}`})},x=({options:e,panels:i,events:s={},methods:c={},plugins:r,siblings:o=[],imports:h=[],viewportClass:g=""})=>{let x=a(e),m=i.filter(e=>e.isSlot),z=r?`,
  data() {
    return {
      plugins: [${p(r)}]
    }
  ...
  </template>`:"",b=[...(r??[]).map(e=>[`{ ${e[0]} }`,"@egjs/flicking-plugins"]),...h],f=Object.keys(c),v=f.length>0?`,
  methods: {
    ${f.map(e=>`${e}: ${c[e].split("\n").map((e,i)=>i>0?`    ${e}`:e).join("\n")}`).join(",\n")}
  }`:"",$=Object.keys(s).map(e=>` @${e.replace(/([A-Z])/g,"-$1").toLowerCase()}="${s[e]}"`).join("");return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(n.A,{className:"language-html",title:"template",children:`<Flicking${g&&` class="${g}"`}${e?` :options="{ ${x} }"`:""}${r?' :plugins="plugins"':""}${$}>
  ${i.filter(e=>!e.isSlot).map(e=>`<${e.tag}${l(e)}${d(e)}>${e.content}</${e.tag}>`).join("\n  ")}${j}
</Flicking>${o?`
${o.map(e=>`<${e.tag}${l(e)}${d(e)}>${e.content}</${e.tag}>`).join("\n")}`:""}`}),(0,t.jsx)(n.A,{className:"language-js",title:"script",children:`${u(b,{prefix:"vue3"})}

export default {
  components: {
    Flicking
  }${z}${v}
}`})]})},m=({js:e,react:i,vue3:s,style:o,...l})=>(0,t.jsxs)("div",{children:[(0,t.jsxs)(r.A,{groupId:"cfc",defaultValue:"js",children:[(0,t.jsx)(c.A,{value:"react",label:"React",children:i||(0,t.jsx)(g,{...l})}),(0,t.jsx)(c.A,{value:"vue3",label:"Vue@3",children:s||(0,t.jsx)(x,{...l})}),(0,t.jsx)(c.A,{value:"js",label:"JavaScript",children:e||(0,t.jsx)(h,{...l})})]}),o&&(0,t.jsx)(n.A,{className:"language-css",title:"style",children:`${o}`})]})}}]);