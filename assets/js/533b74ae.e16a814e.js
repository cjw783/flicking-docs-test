...
`;function d({code:e,html:i,template:s="react",dependencies:c={},files:d={},css:g=""}){var h;let p,x,j;return(0,n.jsx)(t.OZ,{template:"vue3"===s?"vue":"vanilla"===s?"vanilla":"react",files:(j={"/styles.css":{code:x=g?`${o}
${g}`:o},...d},"react"===s?{"/App.tsx":{code:e},"/index.js":{code:a,hidden:!0},...j}:"vue3"===s?{"/src/App.vue":{code:e},...j}:{"/src/index.js":{code:e},"/index.js":{code:function(e){let i=e.split("\n"),s=[],n=[],t=!1;for(let e of i)t?n.push(e):e.trimStart().startsWith("import ")||""===e.trim()?s.push(e.replace('"../styles.css"','"./styles.css"')):(t=!0,n.push(e));for(;n.length>0&&""===n[n.length-1].trim();)n.pop();return[...s,"","const _run = () => {",...n.map(e=>`  ${e}`),'  document.querySelectorAll(".flicking-viewport").forEach(el => { el.style.opacity = "1"; });',"};","",'if (document.readyState === "loading") {','  document.addEventListener("DOMContentLoaded", _run);',"} else {","  _run();","}"].join("\n")}(e),hidden:!0},"/styles.css":{code:x},"/index.html":{code:(p="<style>.flicking-viewport{opacity:0}</style>",(h=i||r).includes("</head>")?h.replace("</head>",`${p}
</head>`):p+h)},...d}),customSetup:{dependencies:{...l[s],...c}},options:{showLineNumbers:!0,editorHeight:400,externalResources:[],visibleFiles:"react"===s?["/App.tsx","/styles.css"]:"vue3"===s?["/src/App.vue","/styles.css"]:["/src/index.js","/index.html","/styles.css"],activeFile:"react"===s?"/App.tsx":"vue3"===s?"/src/App.vue":"/src/index.js"}})}},72722(e,i,s){s.d(i,{A:()=>f});var n=s(65723),t=s(34622),c=s(7210),l=s(78863);s(22155);let r=(e,i='"')=>"string"==typeof e?`${i}${e}${i}`:e,a=(e,i="class")=>e.class?` ${i}="${e.class}"`:"",o=(e,i=!1)=>e.style?i?` style={{ ${Object.keys(e.style).map(i=>`${i}: ${r(e.style[i])}`).join(", ")} }}`:` style="${Object.keys(e.style).map(i=>`${i}: ${e.style[i]};`).join(" ")}"`:"",d=e=>`${Object.keys(e).map(i=>`${i}: ${r(e[i],"'")}`).join(", ")}`,g=(e,{prefix:i,includeFlicking:s=!0}={})=>{let n=s?[["Flicking",`@egjs/${i?`${i}-`:""}flicking`]]:[];return e&&n.push(...e),`${n.map(e=>Array.isArray(e)?`import ${e[0]} from "${e[1]}";`:`import "${e}";`).join("\n")}`},h=e=>`${e.map(e=>`new ${e[0]}(${"object"==typeof e[1]?`{ ${d(e[1])} }`:e[1]??""}`).join(", ")})`,p=({options:e,panels:i,events:s={},methods:c={},plugins:l=[],siblings:d=[],imports:h=[],viewportClass:p=""})=>{let x=e=>`${Object.keys(e).map(i=>`${i}: ${r(e[i])}`).join(",\n  ")}`,j=Object.keys(c).map(e=>`const ${e} = ${c[e]};
...
export default class DemoComponent extends Component {${x}
  ...
  <template #viewport>
    ${f.map(e=>`<${e.tag}${a(e)}${o(e)}>${e.content}</${e.tag}>`).join("\n    ")}
...
}`})]})},f=({js:e,react:i,vue3:s,style:r,...a})=>(0,n.jsxs)("div",{children:[(0,n.jsxs)(l.A,{groupId:"cfc",defaultValue:"js",children:[(0,n.jsx)(c.A,{value:"react",label:"React",children:i||(0,n.jsx)(x,{...a})}),(0,n.jsx)(c.A,{value:"vue3",label:"Vue@3",children:s||(0,n.jsx)(j,{...a})}),(0,n.jsx)(c.A,{value:"js",label:"JavaScript",children:e||(0,n.jsx)(p,{...a})})]}),r&&(0,n.jsx)(t.A,{className:"language-css",title:"style",children:`${r}`})]})}}]);