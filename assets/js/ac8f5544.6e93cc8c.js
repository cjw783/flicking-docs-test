...
`;function g({code:e,html:i,template:n="react",dependencies:t={},files:l={},css:d=""}){return(0,s.jsx)(a.OZ,{template:"vue3"===n?"vue":"vanilla"===n?"vanilla":"react",files:(()=>{let s=d?`${p}
${d}`:p,t={"/styles.css":{code:s},...l};if("react"===n)return{"/App.tsx":{code:e},"/index.js":{code:o,hidden:!0},...t};if("vue3"===n){let i;return{"/src/App.vue":{code:(i=e.replace(/\n*<style>[\s\S]*?<\/style>/,""),`${i}

<style>
${s}
</style>`)},...l}}return{"/src/index.js":{code:e},"/index.js":{code:'import "./src/index.js";',hidden:!0},"/src/styles.css":{code:s},"/index.html":{code:i||r},...l}})(),customSetup:{dependencies:{...c[n],...t}},options:{showLineNumbers:!0,editorHeight:400,externalResources:[],visibleFiles:"react"===n?["/App.tsx","/styles.css"]:"vue3"===n?["/src/App.vue"]:["/src/index.js","/index.html","/src/styles.css"],activeFile:"react"===n?"/App.tsx":"vue3"===n?"/src/App.vue":"/src/index.js"}})}function u({react:e,vue3:i,js:n,jsHtml:a,css:d,dependencies:c}){return(0,s.jsxs)(l.A,{groupId:"framework",defaultValue:"js",children:[(0,s.jsx)(t.A,{value:"js",label:"JavaScript",children:(0,s.jsx)(g,{template:"vanilla",code:n,html:a,css:d,dependencies:c})}),(0,s.jsx)(t.A,{value:"react",label:"React",children:(0,s.jsx)(g,{template:"react",code:e,css:d,dependencies:c})}),(0,s.jsx)(t.A,{value:"vue3",label:"Vue@3",children:(0,s.jsx)(g,{template:"vue3",code:i,css:d,dependencies:c})})]})}}}]);