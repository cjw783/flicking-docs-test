...
`;function h({code:e,html:i,template:n="react",dependencies:t={},files:r={},css:c=""}){return(0,s.jsx)(l.OZ,{template:"vue3"===n?"vue":"vanilla"===n?"vanilla":"react",files:(()=>{let s=c?`${p}
...
<style>
${s}
</style>`)},...r}}return{"/src/index.js":{code:e},"/index.js":{code:'import "./src/index.js";',hidden:!0},"/src/styles.css":{code:s},"/index.html":{code:i||d},...r}})(),customSetup:{dependencies:{...a[n],...t}},options:{showLineNumbers:!0,editorHeight:400,externalResources:[],visibleFiles:"react"===n?["/App.tsx","/styles.css"]:"vue3"===n?["/src/App.vue"]:["/src/index.js","/index.html","/src/styles.css"],activeFile:"react"===n?"/App.tsx":"vue3"===n?"/src/App.vue":"/src/index.js"}})}function u({react:e,vue3:i,js:n,jsHtml:l,css:c,dependencies:a}){return(0,s.jsxs)(r.A,{groupId:"framework",defaultValue:"js",children:[(0,s.jsx)(t.A,{value:"js",label:"JavaScript",children:(0,s.jsx)(h,{template:"vanilla",code:n,html:l,css:c,dependencies:a})}),(0,s.jsx)(t.A,{value:"react",label:"React",children:(0,s.jsx)(h,{template:"react",code:e,css:c,dependencies:a})}),(0,s.jsx)(t.A,{value:"vue3",label:"Vue@3",children:(0,s.jsx)(h,{template:"vue3",code:i,css:c,dependencies:a})})]})}}}]);