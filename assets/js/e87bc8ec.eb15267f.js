"use strict";(self.webpackChunkdocs=self.webpackChunkdocs||[]).push([["7207"],{82165(e,n,i){i.r(n),i.d(n,{metadata:()=>s,default:()=>b,frontMatter:()=>o,contentTitle:()=>p,toc:()=>h,assets:()=>v});var s=JSON.parse('{"id":"demos/advanced/observe-panel-resize","title":"Observe Panel Resize","description":"observePanelResize \uC635\uC158\uC73C\uB85C \uD328\uB110 \uC694\uC18C\uC758 \uD06C\uAE30 \uBCC0\uACBD\uC744 \uC790\uB3D9\uC73C\uB85C \uAC10\uC9C0\uD574 \uB808\uC774\uC544\uC6C3\uC744 \uC7AC\uACC4\uC0B0\uD569\uB2C8\uB2E4","source":"@site/docs/demos/advanced/observe-panel-resize.mdx","sourceDirName":"demos/advanced","slug":"/demos/advanced/observe-panel-resize","permalink":"/flicking-docs-test/docs/demos/advanced/observe-panel-resize","draft":false,"unlisted":false,"editUrl":"https://github.com/naver/egjs-flicking/edit/master/docs/docs/demos/advanced/observe-panel-resize.mdx","tags":[],"version":"current","sidebarPosition":18,"frontMatter":{"title":"Observe Panel Resize","id":"observe-panel-resize","slug":"/demos/advanced/observe-panel-resize","sidebar_position":18,"description":"observePanelResize \uC635\uC158\uC73C\uB85C \uD328\uB110 \uC694\uC18C\uC758 \uD06C\uAE30 \uBCC0\uACBD\uC744 \uC790\uB3D9\uC73C\uB85C \uAC10\uC9C0\uD574 \uB808\uC774\uC544\uC6C3\uC744 \uC7AC\uACC4\uC0B0\uD569\uB2C8\uB2E4","keywords":["flicking","carousel","observePanelResize","ResizeObserver","resize","\uD328\uB110 \uB9AC\uC0AC\uC774\uC988","\uB3D9\uC801 \uD06C\uAE30"]},"sidebar":"demosSidebar","previous":{"title":"CSS Order","permalink":"/flicking-docs-test/docs/demos/advanced/use-css-order"},"next":{"title":"Progress Bar","permalink":"/flicking-docs-test/docs/demos/reactive/progress-bar"}}'),l=i(65723),t=i(54187),a=i(27449),r=i(72722);i(22155);let c=`
.flicking-panel {
  height: 120px;
...
}`:""})`)});`:"",m=[...a.map(e=>[`{ ${e[0]} }`,"@egjs/flicking-plugins"]),...v],j=Object.keys(i).map(e=>{let n=i[e];return`flicking.on("${e}", ${n})
`}).join(""),f=n.filter(e=>e.isSlot);return(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)(l.A,{className:"language-html",title:"html",children:`<div id="flick" class="flicking-viewport${h&&` ${h}`}${!1===e.horizontal?" vertical":""}">
  <div class="flicking-camera">
...
${b}${u}${x}${j}`.trim()})]})},g=({options:e,panels:n,events:i={},methods:t={},plugins:a,siblings:r,imports:o=[],viewportClass:h=""})=>{let g=a?`
  private _plugins = [${v(a)}];
...
export default class DemoComponent extends Component {${g}
  public render() {
    return ${r?"<>\n    ":""}<Flicking${h&&` className="${h}"`}${e?` ${Object.keys(e).map(n=>`${n}=${"string"==typeof e[n]?`"${e[n]}"`:`{${e[n]}}`}`).join(" ")}`:""}${a?" plugins={this._plugins}":""}${j}>
...
}`})},b=({options:e,panels:n,events:i={},methods:t={},plugins:a,siblings:r=[],imports:h=[],viewportClass:g=""})=>{let b=o(e),u=n.filter(e=>e.isSlot),x=a?`,
  data() {
    return {
      plugins: [${v(a)}]
    }
  ...
  </template>`:"",j=[...(a??[]).map(e=>[`{ ${e[0]} }`,"@egjs/flicking-plugins"]),...h],f=Object.keys(t),k=f.length>0?`,
  methods: {
...
}`})]})},u=({js:e,react:n,vue3:i,style:r,...c})=>(0,s.jsxs)("div",{children:[(0,s.jsxs)(a.A,{groupId:"cfc",defaultValue:"js",children:[(0,s.jsx)(t.A,{value:"react",label:"React",children:n||(0,s.jsx)(g,{...c})}),(0,s.jsx)(t.A,{value:"vue3",label:"Vue@3",children:i||(0,s.jsx)(b,{...c})}),(0,s.jsx)(t.A,{value:"js",label:"JavaScript",children:e||(0,s.jsx)(h,{...c})})]}),r&&(0,s.jsx)(l.A,{className:"language-css",title:"style",children:`${r}`})]})}}]);