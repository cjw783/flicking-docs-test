"use strict";(self.webpackChunkdocs=self.webpackChunkdocs||[]).push([["7305"],{45367(e,i,n){n.r(i),n.d(i,{metadata:()=>t,default:()=>x,frontMatter:()=>d,contentTitle:()=>p,toc:()=>h,assets:()=>g});var t=JSON.parse('{"id":"demos/advanced/pagination","title":"Pagination","description":"Reactive API\uB85C dot \uD398\uC774\uC9C0\uB124\uC774\uC158\uC744 \uAD6C\uD604\uD569\uB2C8\uB2E4","source":"@site/docs/demos/advanced/pagination.mdx","sourceDirName":"demos/advanced","slug":"/demos/advanced/pagination","permalink":"/flicking-docs-test/ko/docs/demos/advanced/pagination","draft":false,"unlisted":false,"editUrl":"https://github.com/naver/egjs-flicking/edit/master/docs/docs/demos/advanced/pagination.mdx","tags":[],"version":"current","sidebarPosition":13,"frontMatter":{"title":"Pagination","id":"pagination","slug":"/demos/advanced/pagination","sidebar_position":13,"description":"Reactive API\uB85C dot \uD398\uC774\uC9C0\uB124\uC774\uC158\uC744 \uAD6C\uD604\uD569\uB2C8\uB2E4","keywords":["flicking","carousel","pagination","dot","reactive","currentPanelIndex"]},"sidebar":"demosSidebar","previous":{"title":"Progress Bar","permalink":"/flicking-docs-test/ko/docs/demos/advanced/progress-bar"},"next":{"title":"Prev / Next","permalink":"/flicking-docs-test/ko/docs/demos/advanced/prev-next"}}'),l=n(65723),c=n(54187),s=n(27449),a=n(72722);n(22155);let r=`
.flicking-panel {
  width: 300px;
  height: 150px;
  margin-right: 10px;
...
`;function d({code:e,html:i,template:n="react",dependencies:c={},files:d={},css:p=""}){var g;let h,u,x;return(0,t.jsx)(l.OZ,{template:"vue3"===n?"vue":"vanilla"===n?"vanilla":"react",files:(x={"/styles.css":{code:u=p?`${o}
${p}`:o},...d},"react"===n?{"/App.tsx":{code:e},"/index.js":{code:r,hidden:!0},...x}:"vue3"===n?{"/src/App.vue":{code:e},...x}:{"/src/index.js":{code:e},"/index.js":{code:function(e){let i=e.split("\n"),n=[],t=[],l=!1;for(let e of i)l?t.push(e):e.trimStart().startsWith("import ")||""===e.trim()?n.push(e.replace('"../styles.css"','"./styles.css"')):(l=!0,t.push(e));for(;t.length>0&&""===t[t.length-1].trim();)t.pop();return[...n,"","const _run = () => {",...t.map(e=>`  ${e}`),'  document.querySelectorAll(".flicking-viewport").forEach(el => { el.style.opacity = "1"; });',"};","",'if (document.readyState === "loading") {','  document.addEventListener("DOMContentLoaded", _run);',"} else {","  _run();","}"].join("\n")}(e),hidden:!0},"/styles.css":{code:u},"/index.html":{code:(h="<style>.flicking-viewport{opacity:0}</style>",(g=i||a).includes("</head>")?g.replace("</head>",`${h}
</head>`):h+g)},...d}),customSetup:{dependencies:{...s[n],...c}},options:{showLineNumbers:!0,editorHeight:400,externalResources:[],visibleFiles:"react"===n?["/App.tsx","/styles.css"]:"vue3"===n?["/src/App.vue","/styles.css"]:["/src/index.js","/index.html","/styles.css"],activeFile:"react"===n?"/App.tsx":"vue3"===n?"/src/App.vue":"/src/index.js"}})}},72722(e,i,n){n.d(i,{A:()=>j});var t=n(65723),l=n(34622),c=n(7210),s=n(78863);n(22155);let a=(e,i='"')=>"string"==typeof e?`${i}${e}${i}`:e,r=(e,i="class")=>e.class?` ${i}="${e.class}"`:"",o=(e,i=!1)=>e.style?i?` style={{ ${Object.keys(e.style).map(i=>`${i}: ${a(e.style[i])}`).join(", ")} }}`:` style="${Object.keys(e.style).map(i=>`${i}: ${e.style[i]};`).join(" ")}"`:"",d=e=>`${Object.keys(e).map(i=>`${i}: ${a(e[i],"'")}`).join(", ")}`,p=(e,{prefix:i,includeFlicking:n=!0}={})=>{let t=n?[["Flicking",`@egjs/${i?`${i}-`:""}flicking`]]:[];return e&&t.push(...e),`${t.map(e=>Array.isArray(e)?`import ${e[0]} from "${e[1]}";`:`import "${e}";`).join("\n")}`},g=e=>`${e.map(e=>`new ${e[0]}(${"object"==typeof e[1]?`{ ${d(e[1])} }`:e[1]??""}`).join(", ")})`,h=({options:e,panels:i,events:n={},methods:c={},plugins:s=[],siblings:d=[],imports:g=[],viewportClass:h=""})=>{let u=e=>`${Object.keys(e).map(i=>`${i}: ${a(e[i])}`).join(",\n  ")}`,x=Object.keys(c).map(e=>`const ${e} = ${c[e]};
...
${x}${j}${m}${v}`.trim()})]})},u=({options:e,panels:i,events:n={},methods:c={},plugins:s,siblings:a,imports:d=[],viewportClass:h=""})=>{let u=s?`
...
const ${e} = ${c[e]};`).join("");m&&(m+="\n"),s&&j.push([`{ ${s.map(e=>e[0])} }`,"@egjs/flicking-plugins"]),j.push(...d);let f=x.length?`
      <ViewportSlot>
...
export default class DemoComponent extends Component {${u}
...
}`})},x=({options:e,panels:i,events:n={},methods:c={},plugins:s,siblings:a=[],imports:h=[],viewportClass:u=""})=>{let x=d(e),j=i.filter(e=>e.isSlot),m=s?`,
  data() {
    return {
      plugins: [${g(s)}]
    }
  ...
  <template #viewport>
    ${j.map(e=>`<${e.tag}${r(e)}${o(e)}>${e.content}</${e.tag}>`).join("\n    ")}
