...
`;function h({code:e,html:i,template:n="react",dependencies:c={},files:t={},css:l=""}){return(0,s.jsx)(r.OZ,{template:"vue3"===n?"vue":"vanilla"===n?"vanilla":"react",files:(()=>{let s=l?`${p}
${l}`:p,c={"/styles.css":{code:s},...t};if("react"===n)return{"/App.tsx":{code:e},"/index.js":{code:a,hidden:!0},...c};if("vue3"===n){let i;return{"/src/App.vue":{code:(i=e.replace(/\n*<style>[\s\S]*?<\/style>/,""),`${i}

<style>
${s}
</style>`)},...t}}return{"/src/index.js":{code:e},"/index.js":{code:'import "./src/index.js";',hidden:!0},"/src/styles.css":{code:s},"/index.html":{code:i||o},...t}})(),customSetup:{dependencies:{...d[n],...c}},options:{showLineNumbers:!0,editorHeight:400,externalResources:[],visibleFiles:"react"===n?["/App.tsx","/styles.css"]:"vue3"===n?["/src/App.vue"]:["/src/index.js","/index.html","/src/styles.css"],activeFile:"react"===n?"/App.tsx":"vue3"===n?"/src/App.vue":"/src/index.js"}})}function g({react:e,vue3:i,js:n,jsHtml:r,css:l,dependencies:d}){return(0,s.jsxs)(t.A,{groupId:"framework",defaultValue:"js",children:[(0,s.jsx)(c.A,{value:"js",label:"JavaScript",children:(0,s.jsx)(h,{template:"vanilla",code:n,html:r,css:l,dependencies:d})}),(0,s.jsx)(c.A,{value:"react",label:"React",children:(0,s.jsx)(h,{template:"react",code:e,css:l,dependencies:d})}),(0,s.jsx)(c.A,{value:"vue3",label:"Vue@3",children:(0,s.jsx)(h,{template:"vue3",code:i,css:l,dependencies:d})})]})}}}]);