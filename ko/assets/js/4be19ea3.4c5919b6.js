"use strict";(self.webpackChunkdocs=self.webpackChunkdocs||[]).push([["4634"],{98955(e,i,n){n.r(i),n.d(i,{metadata:()=>s,default:()=>m,frontMatter:()=>d,contentTitle:()=>p,toc:()=>h,assets:()=>g});var s=JSON.parse('{"id":"demos/advanced/cross-flicking","title":"Cross Flicking","description":"nested \uC635\uC158\uC73C\uB85C \uAC00\uB85C/\uC138\uB85C \uC911\uCCA9 Flicking\uC744 \uAD6C\uC131\uD569\uB2C8\uB2E4","source":"@site/docs/demos/advanced/cross-flicking.mdx","sourceDirName":"demos/advanced","slug":"/demos/advanced/cross-flicking","permalink":"/flicking-docs-test/ko/docs/demos/advanced/cross-flicking","draft":false,"unlisted":false,"editUrl":"https://github.com/naver/egjs-flicking/edit/master/docs/docs/demos/advanced/cross-flicking.mdx","tags":[],"version":"current","sidebarPosition":15,"frontMatter":{"title":"Cross Flicking","id":"cross-flicking","slug":"/demos/advanced/cross-flicking","sidebar_position":15,"description":"nested \uC635\uC158\uC73C\uB85C \uAC00\uB85C/\uC138\uB85C \uC911\uCCA9 Flicking\uC744 \uAD6C\uC131\uD569\uB2C8\uB2E4","keywords":["flicking","carousel","nested","cross","\uC911\uCCA9","\uAC00\uB85C\uC138\uB85C"]},"sidebar":"demosSidebar","previous":{"title":"Prev / Next","permalink":"/flicking-docs-test/ko/docs/demos/advanced/prev-next"},"next":{"title":"Fade","permalink":"/flicking-docs-test/ko/docs/demos/plugins/fade"}}'),t=n(65723),l=n(54187),r=n(27449),c=n(72722);n(22155);let o=`
.outer-viewport {
  height: 250px;
}
...
${m}${x}${j}${$}`.trim()})]})},u=({options:e,panels:i,events:n={},methods:l={},plugins:r,siblings:c,imports:d=[],viewportClass:h=""})=>{let u=r?`
...
}`})},m=({options:e,panels:i,events:n={},methods:l={},plugins:r,siblings:c=[],imports:h=[],viewportClass:u=""})=>{let m=d(e),x=i.filter(e=>e.isSlot),j=r?`,
  data() {
    return {
      plugins: [${g(r)}]
    }
