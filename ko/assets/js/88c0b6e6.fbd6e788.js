"use strict";(self.webpackChunkdocs=self.webpackChunkdocs||[]).push([["6812"],{15066(e,i,n){n.r(i),n.d(i,{metadata:()=>l,default:()=>x,frontMatter:()=>o,contentTitle:()=>p,toc:()=>g,assets:()=>h});var l=JSON.parse('{"id":"demos/basic/default","title":"Default","description":"Flicking\uC758 \uAE30\uBCF8 \uC0AC\uC6A9\uBC95\uACFC \uD544\uC218 \uAD6C\uC870\uB97C \uBCF4\uC5EC\uC8FC\uB294 \uB370\uBAA8","source":"@site/docs/demos/basic/default.mdx","sourceDirName":"demos/basic","slug":"/demos/basic/default","permalink":"/flicking-docs-test/ko/docs/demos/basic/default","draft":false,"unlisted":false,"editUrl":"https://github.com/naver/egjs-flicking/edit/master/docs/docs/demos/basic/default.mdx","tags":[],"version":"current","sidebarPosition":1,"frontMatter":{"title":"Default","id":"default","slug":"/demos/basic/default","sidebar_position":1,"description":"Flicking\uC758 \uAE30\uBCF8 \uC0AC\uC6A9\uBC95\uACFC \uD544\uC218 \uAD6C\uC870\uB97C \uBCF4\uC5EC\uC8FC\uB294 \uB370\uBAA8","keywords":["flicking","carousel","basic","default","\uAE30\uBCF8","\uC2DC\uC791\uD558\uAE30"]},"sidebar":"demosSidebar","next":{"title":"Alignment","permalink":"/flicking-docs-test/ko/docs/demos/basic/alignment"}}'),s=n(65723),t=n(54187),c=n(27449),r=n(72722);n(22155);let a=`
.flicking-panel {
  width: 100%;
}
...
}`:""})`)});`:"",u=[...c.map(e=>[`{ ${e[0]} }`,"@egjs/flicking-plugins"]),...h],k=Object.keys(n).map(e=>{let i=n[e];return`flicking.on("${e}", ${i})
...
${x}${m}${f}${k}`.trim()})]})},j=({options:e,panels:i,events:n={},methods:t={},plugins:c,siblings:r,imports:o=[],viewportClass:g=""})=>{let j=c?`
...
const ${e} = ${t[e]};`).join("");f&&(f+="\n"),c&&m.push([`{ ${c.map(e=>e[0])} }`,"@egjs/flicking-plugins"]),m.push(...o);let u=x.length?`
      ...
      </ViewportSlot>`:"",k=Object.keys(n).map(e=>` on${e[0].toUpperCase()+e.slice(1)}={${n[e]}}`).join("");return(0,l.jsx)(s.A,{className:"language-jsx",title:"DemoComponent.jsx",children:`${p(m,{includeFlicking:!1})}
${f}
export default class DemoComponent extends Component {${j}
  ...
  </template>`:"",k=[...(c??[]).map(e=>[`{ ${e[0]} }`,"@egjs/flicking-plugins"]),...g],$=Object.keys(t),v=$.length>0?`,
  methods: {
