"use strict";(self.webpackChunkdocs=self.webpackChunkdocs||[]).push([["364"],{22403(i,e,n){n.r(e),n.d(e,{metadata:()=>t,default:()=>f,frontMatter:()=>r,contentTitle:()=>p,toc:()=>u,assets:()=>g});var t=JSON.parse('{"id":"demos/basic/auto-init","title":"Auto Init","description":"autoInit \uC635\uC158\uC73C\uB85C \uC778\uC2A4\uD134\uC2A4 \uC0DD\uC131 \uC2DC \uC790\uB3D9 \uCD08\uAE30\uD654 \uC5EC\uBD80\uB97C \uC124\uC815\uD569\uB2C8\uB2E4","source":"@site/docs/demos/basic/auto-init.mdx","sourceDirName":"demos/basic","slug":"/demos/basic/auto-init","permalink":"/flicking-docs-test/ko/docs/demos/basic/auto-init","draft":false,"unlisted":false,"editUrl":"https://github.com/naver/egjs-flicking/edit/master/docs/docs/demos/basic/auto-init.mdx","tags":[],"version":"current","sidebarPosition":15,"frontMatter":{"title":"Auto Init","id":"auto-init","slug":"/demos/basic/auto-init","sidebar_position":15,"description":"autoInit \uC635\uC158\uC73C\uB85C \uC778\uC2A4\uD134\uC2A4 \uC0DD\uC131 \uC2DC \uC790\uB3D9 \uCD08\uAE30\uD654 \uC5EC\uBD80\uB97C \uC124\uC815\uD569\uB2C8\uB2E4","keywords":["flicking","carousel","autoInit","init","initialization","\uCD08\uAE30\uD654","\uC9C0\uC5F0"]},"sidebar":"demosSidebar","previous":{"title":"Default Index","permalink":"/flicking-docs-test/ko/docs/demos/basic/default-index"},"next":{"title":"Adaptive","permalink":"/flicking-docs-test/ko/docs/demos/basic/adaptive"}}'),l=n(65723),s=n(54187),a=n(27449),c=n(72722);n(22155);let d=`
.flicking-panel {
  width: 50%;
  height: 120px;
}
...
`,o=()=>{let i=`import { useRef, useState } from "react";
...
`;function r({code:i,html:e,template:n="react",dependencies:s={},files:r={},css:p=""}){var g;let u,h,f;return(0,t.jsx)(l.OZ,{template:"vue3"===n?"vue":"vanilla"===n?"vanilla":"react",files:(f={"/styles.css":{code:h=p?`${o}
${p}`:o},...r},"react"===n?{"/App.tsx":{code:i},"/index.js":{code:d,hidden:!0},...f}:"vue3"===n?{"/src/App.vue":{code:i},...f}:{"/src/index.js":{code:i},"/index.js":{code:function(i){let e=i.split("\n"),n=[],t=[],l=!1;for(let i of e)l?t.push(i):i.trimStart().startsWith("import ")||""===i.trim()?n.push(i.replace('"../styles.css"','"./styles.css"')):(l=!0,t.push(i));for(;t.length>0&&""===t[t.length-1].trim();)t.pop();return[...n,"","const _run = () => {",...t.map(i=>`  ${i}`),'  document.querySelectorAll(".flicking-viewport").forEach(el => { el.style.opacity = "1"; });',"};","",'if (document.readyState === "loading") {','  document.addEventListener("DOMContentLoaded", _run);',"} else {","  _run();","}"].join("\n")}(i),hidden:!0},"/styles.css":{code:h},"/index.html":{code:(u="<style>.flicking-viewport{opacity:0}</style>",(g=e||c).includes("</head>")?g.replace("</head>",`${u}
</head>`):u+g)},...r}),customSetup:{dependencies:{...a[n],...s}},options:{showLineNumbers:!0,editorHeight:400,externalResources:[],visibleFiles:"react"===n?["/App.tsx","/styles.css"]:"vue3"===n?["/src/App.vue","/styles.css"]:["/src/index.js","/index.html","/styles.css"],activeFile:"react"===n?"/App.tsx":"vue3"===n?"/src/App.vue":"/src/index.js"}})}},72722(i,e,n){n.d(e,{A:()=>m});var t=n(65723),l=n(34622),s=n(7210),a=n(78863);n(22155);let c=(i,e='"')=>"string"==typeof i?`${e}${i}${e}`:i,d=(i,e="class")=>i.class?` ${e}="${i.class}"`:"",o=(i,e=!1)=>i.style?e?` style={{ ${Object.keys(i.style).map(e=>`${e}: ${c(i.style[e])}`).join(", ")} }}`:` style="${Object.keys(i.style).map(e=>`${e}: ${i.style[e]};`).join(" ")}"`:"",r=i=>`${Object.keys(i).map(e=>`${e}: ${c(i[e],"'")}`).join(", ")}`,p=(i,{prefix:e,includeFlicking:n=!0}={})=>{let t=n?[["Flicking",`@egjs/${e?`${e}-`:""}flicking`]]:[];return i&&t.push(...i),`${t.map(i=>Array.isArray(i)?`import ${i[0]} from "${i[1]}";`:`import "${i}";`).join("\n")}`},g=i=>`${i.map(i=>`new ${i[0]}(${"object"==typeof i[1]?`{ ${r(i[1])} }`:i[1]??""}`).join(", ")})`,u=({options:i,panels:e,events:n={},methods:s={},plugins:a=[],siblings:r=[],imports:g=[],viewportClass:u=""})=>{let h=i=>`${Object.keys(i).map(e=>`${e}: ${c(i[e])}`).join(",\n  ")}`,f=Object.keys(s).map(i=>`const ${i} = ${s[i]};
...
}`:""})`)});`:"",j=[...a.map(i=>[`{ ${i[0]} }`,"@egjs/flicking-plugins"]),...g],x=Object.keys(n).map(i=>{let e=n[i];return`flicking.on("${i}", ${e})
`}).join(""),k=e.filter(i=>i.isSlot);return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(l.A,{className:"language-html",title:"html",children:`<div id="flick" class="flicking-viewport${u&&` ${u}`}${!1===i.horizontal?" vertical":""}">
  <div class="flicking-camera">
    ${e.filter(i=>!i.isSlot).map(i=>`<${i.tag}${d(i)}${o(i)}>${i.content}</${i.tag}>`).join("\n    ")}
  </div>${k.length?`
  ${k.map(i=>`<${i.tag}${d(i)}${o(i)}>${i.content}</${i.tag}>`).join("\n  ")}`:""}
</div>${r?"\n"+r.map(i=>`<${i.tag}${d(i)}${o(i)}>${i.content}</${i.tag}>`).join("\n"):""}`}),(0,t.jsx)(l.A,{className:"language-js",title:"js",children:`${p(j)}

${f}${m}${v}${x}`.trim()})]})},h=({options:i,panels:e,events:n={},methods:s={},plugins:a,siblings:c,imports:r=[],viewportClass:u=""})=>{let h=a?`
  private _plugins = [${g(a)}];
`:"",f=e.filter(i=>i.isSlot),m=[["{ Component }","react"],[f.length?"Flicking, { ViewportSlot }":"Flicking","@egjs/react-flicking"]],v=Object.keys(s).map(i=>`
const ${i} = ${s[i]};`).join("");v&&(v+="\n"),a&&m.push([`{ ${a.map(i=>i[0])} }`,"@egjs/flicking-plugins"]),m.push(...r);let j=f.length?`
      <ViewportSlot>
        ${f.map(i=>`<${i.tag}${d(i,"className")}${o(i,!0)}>${i.content.replace(/class/g,"className")}</${i.tag}>`).join("\n        ")}
      </ViewportSlot>`:"",x=Object.keys(n).map(i=>` on${i[0].toUpperCase()+i.slice(1)}={${n[i]}}`).join("");return(0,t.jsx)(l.A,{className:"language-jsx",title:"DemoComponent.jsx",children:`${p(m,{includeFlicking:!1})}
${v}
export default class DemoComponent extends Component {${h}
  public render() {
    return ${c?"<>\n    ":""}<Flicking${u&&` className="${u}"`}${i?` ${Object.keys(i).map(e=>`${e}=${"string"==typeof i[e]?`"${i[e]}"`:`{${i[e]}}`}`).join(" ")}`:""}${a?" plugins={this._plugins}":""}${x}>
      ${e.filter(i=>!i.isSlot).map(i=>`<${i.tag}${d(i,"className")}${o(i,!0)}>${i.content.replace(/class/g,"className")}</${i.tag}>`).join("\n      ")}${j}
    </Flicking>${c?`
    ${c.map(i=>`<${i.tag}${d(i,"className")}${o(i,!0)}>${i.content.replace(/class/g,"className")}</${i.tag}>`).join("\n    ")}
    </>`:""};
  }
}`})},f=({options:i,panels:e,events:n={},methods:s={},plugins:a,siblings:c=[],imports:u=[],viewportClass:h=""})=>{let f=r(i),m=e.filter(i=>i.isSlot),v=a?`,
  data() {
    return {
      plugins: [${g(a)}]
    }
  ...
  <template #viewport>
    ${m.map(i=>`<${i.tag}${d(i)}${o(i)}>${i.content}</${i.tag}>`).join("\n    ")}
  </template>`:"",x=[...(a??[]).map(i=>[`{ ${i[0]} }`,"@egjs/flicking-plugins"]),...u],k=Object.keys(s),$=k.length>0?`,
  methods: {
...
${c.map(i=>`<${i.tag}${d(i)}${o(i)}>${i.content}</${i.tag}>`).join("\n")}`:""}`}),(0,t.jsx)(l.A,{className:"language-js",title:"script",children:`${p(x,{prefix:"vue3"})}
