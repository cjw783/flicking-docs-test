...
Use the [`animationThreshold`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#animationthreshold) option to set the minimum movement distance (px) to trigger an animation. If the movement distance is less than this value, the panel moves instantly without animation.
...
|--------|------|---------|-------------|
| [`animationThreshold`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#animationthreshold) | `number` | `0.5` | Minimum movement distance to trigger animation (px) |
...
- [`easing`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#easing): Animation easing curve

### Related Demos
- [Duration](https://cjw783.github.io/flicking-docs-test/docs/basic/duration): Animation duration setting
- [Interruptable](https://cjw783.github.io/flicking-docs-test/docs/basic/interruptable): Input handling during animation
