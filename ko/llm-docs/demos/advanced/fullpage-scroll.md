...
Combine the [`moveType: "strict"`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#movetype), [`bound`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#bound), and [`align`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#align) options to build a fullpage scroll UI.
...
|--------|------|-------|------|
| [`moveType`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#movetype) | `string` | `"strict"` | Move only one page at a time |
| [`bound`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#bound) | `boolean` | `true` | Prevent empty space at both ends |
| [`align`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#align) | `string` | `"prev"` | Align pages to the viewport start |
| [`horizontal`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#horizontal) | `boolean` | `false` | Vertical scrolling |
...
### Related Options
- [`moveType`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#movetype): Movement type
- [`bound`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#bound): Boundary restriction
- [`horizontal`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#horizontal): Scroll direction
- [`preventDefaultOnDrag`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#preventdefaultondrag): Prevent default behavior on drag

### Related Demos
- [Movement Types](https://cjw783.github.io/flicking-docs-test/docs/basic/movement-types): Detailed comparison of moveType options
- [Carousel](https://cjw783.github.io/flicking-docs-test/docs/carousel): Other option combination patterns
