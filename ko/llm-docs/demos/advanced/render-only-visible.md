...
Use the [`renderOnlyVisible`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#renderonlyvisible) option to keep only visible panels in the DOM, improving performance.
...
|--------|------|---------|-------------|
| [`renderOnlyVisible`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#renderonlyvisible) | `boolean` | `false` | Keep only visible panels in the DOM |
...
### Related Options
- [`virtual`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#virtual): Virtualization that limits DOM elements themselves

### Related Demos
- [Virtual Scroll](https://cjw783.github.io/flicking-docs-test/docs/virtual-scroll): Virtualization using the virtual option
- [Lazy Load](https://cjw783.github.io/flicking-docs-test/docs/lazy-load): Lazy loading combined with renderOnlyVisible
