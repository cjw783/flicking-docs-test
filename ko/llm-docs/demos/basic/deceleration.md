...
The [`deceleration`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#deceleration) option sets the deceleration rate of inertial movement after a user flick. Higher values cause it to stop faster, while lower values make it travel farther.
...
|--------|------|---------|-------------|
| [`deceleration`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#deceleration) | `number` | `0.0075` | Inertial movement deceleration rate |
...
### Related Options
- [`moveType`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#movetype): Movement behavior mode (effect is more pronounced with freeScroll)
- [`duration`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#duration): Snap animation time

### Related Demos
- [Movement Types](https://cjw783.github.io/flicking-docs-test/docs/movement-types): freeScroll mode
- [Duration](https://cjw783.github.io/flicking-docs-test/docs/duration): Animation time
