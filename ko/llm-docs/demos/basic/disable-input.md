...
The [`disableOnInit`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#disableoninit) option disables user input (drag) on initialization. Useful for carousels controlled only by buttons or the API.
...
|--------|------|---------|-------------|
| [`disableOnInit`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#disableoninit) | `boolean` | `false` | Disable input on initialization |
...
### Related Options
- [`inputType`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#inputtype): Input device type restriction

### Related Demos
- [Input Type](https://cjw783.github.io/flicking-docs-test/docs/input-type): Input device type settings
