...
- [React Guide](https://cjw783.github.io/flicking-docs-test/docs/react-guide) - Using `useRef` and event handlers
- [Vue3 Guide](https://cjw783.github.io/flicking-docs-test/docs/vue3-guide) - Using `ref` and event bindings
- [Quick Start](https://cjw783.github.io/flicking-docs-test/docs/quickstart) - Vanilla JavaScript usage

---

## Method Patterns

Common patterns for controlling Flicking programmatically. See the [Flicking API](https://cjw783.github.io/flicking-docs-test/docs/api/classes/Flicking) for complete method reference.
...
Understanding Flicking's event system. See [Event Interfaces](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/ChangedEvent) for complete event reference.
...
**Panel Change Events**
- [`willChange`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/WillChangeEvent) - Fired BEFORE panel changes (cancellable with `e.stop()`)
- [`changed`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/ChangedEvent) - Fired AFTER panel changes

**Movement Events**
- [`moveStart`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/MoveStartEvent) - Animation starts
- [`move`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/MoveEvent) - Continuously fired during movement
- [`moveEnd`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/MoveEndEvent) - Animation ends

**User Input Events**
- [`holdStart`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/HoldStartEvent) / [`holdEnd`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/HoldEndEvent) - Touch/click events
- [`select`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/SelectEvent) - Panel clicked/tapped

**Other Events**
- `ready` - Flicking initialized
- [`needPanel`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/NeedPanelEvent) - For lazy loading
- [`visibleChange`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/VisibleChangeEvent) - Visible panels changed
...
Flicking throws [`FlickingError`](https://cjw783.github.io/flicking-docs-test/docs/api/classes/FlickingError) instances with `ERROR_CODE` constants. See [FlickingError API](https://cjw783.github.io/flicking-docs-test/docs/api/classes/FlickingError) for complete error reference.
