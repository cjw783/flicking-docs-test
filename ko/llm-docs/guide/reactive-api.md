...
|----------|------|-------------|
| [`currentPanelIndex`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingReactiveState#currentpanelindex) | `number` | Index of the currently active panel |
| [`totalPanelCount`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingReactiveState#totalpanelcount) | `number` | Total number of panels |
| [`progress`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingReactiveState#progress) | `number` | Overall scroll progress as a percentage (0-100) |
| [`indexProgress`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingReactiveState#indexprogress) | `number` | Camera position as a fractional panel index (e.g., `2.5` means halfway between panel 2 and 3) |
| [`isReachStart`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingReactiveState#isreachstart) | `boolean` | Whether the first panel is currently active |
| [`isReachEnd`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingReactiveState#isreachend) | `boolean` | Whether the last panel is currently active |
...
|--------|------|-------------|
| [`moveTo`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingReactiveMethod#moveto) | `(index: number) => Promise<void>` | Move to a specific panel by index. Ignores calls while animating. |
...
|--------|------|---------|-------------|
| [`defaultIndex`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingReactiveAPIOptions#defaultindex) | `number` | `0` | Initial panel index. Also affects `isReachStart`, `isReachEnd`, and `indexProgress` initial values. |
| [`totalPanelCount`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingReactiveAPIOptions#totalpanelcount) | `number` | `0` | Initial panel count. Prevents layout shifts when pagination UI depends on this value. |

---

## Next Steps

- **[Demos](https://cjw783.github.io/flicking-docs-test/docs/demos/reactive/progress-bar)**: See Reactive API in action with interactive examples
- **[API Reference](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingReactiveState)**: Full type definitions and property details
