...
These errors can occur when calling [update](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/Plugin_2#update) to manually update the animation state.
