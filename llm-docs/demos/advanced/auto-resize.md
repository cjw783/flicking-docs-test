...
Control how viewport size changes are detected using the [`autoResize`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#autoresize) and [`useResizeObserver`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#useresizeobserver) options.
...
|--------|------|---------|-------------|
| [`autoResize`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#autoresize) | `boolean` | `true` | Automatically call `resize()` when viewport size changes |
| [`useResizeObserver`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#useresizeobserver) | `boolean` | `true` | Whether to use ResizeObserver (falls back to window resize if false) |
...
### Related Options
- [`autoResize`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#autoresize): Auto resize
- [`useResizeObserver`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#useresizeobserver): Use ResizeObserver
...
- [Observe Panel Resize](https://cjw783.github.io/flicking-docs-test/docs/observe-panel-resize): Detect panel size changes
