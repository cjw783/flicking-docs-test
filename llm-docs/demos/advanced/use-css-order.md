...
Use the [`useCSSOrder`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#usecssorder) option to control how panel visual order is managed in `circular` mode. The default (`false`) directly changes the DOM node order, while setting it to `true` uses the CSS `order` property to keep DOM order unchanged.
...
|--------|------|---------|-------------|
| [`useCSSOrder`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#usecssorder) | `boolean` | `false` | Manage panel order via CSS order property |
...
### Related Options
- [`circular`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#circular): Circular mode setting
...
### Related Demos
- [Circular](https://cjw783.github.io/flicking-docs-test/docs/basic/circular): Basic circular mode usage
