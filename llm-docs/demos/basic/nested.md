...
The [`nested`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#nested) option transfers control to the parent Flicking when the child Flicking reaches its boundary. Provides a natural UX for same-direction nested Flicking instances.
...
|--------|------|---------|-------------|
| [`nested`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#nested) | `boolean` | `false` | Transfer control to parent when reaching boundary |
...
### Related Options
- [`bound`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#bound): Boundary restriction (recommended with nested)
- [`horizontal`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#horizontal): Movement direction

### Related Demos
- [Bound](https://cjw783.github.io/flicking-docs-test/docs/bound): Boundary restriction mode
- [Vertical](https://cjw783.github.io/flicking-docs-test/docs/vertical): Vertical mode (different direction combination)
