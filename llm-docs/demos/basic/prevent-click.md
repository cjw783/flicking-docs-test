...
The [`preventClickOnDrag`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#preventclickondrag) option prevents unintended click events that occur after dragging. This is especially important when panels contain links or buttons.
...
|--------|------|---------|-------------|
| [`preventClickOnDrag`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#preventclickondrag) | `boolean` | `true` | Prevent click events after drag |
| [`preventDefaultOnDrag`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#preventdefaultondrag) | `boolean` | `false` | Prevent browser default behavior during drag |
...
### Related Options
- [`inputType`](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/FlickingOptions#inputtype): Input device type settings
...
### Related Demos
- [Input Type](https://cjw783.github.io/flicking-docs-test/docs/input-type): Input device type restriction
- [Threshold](https://cjw783.github.io/flicking-docs-test/docs/threshold): Panel transition threshold settings
