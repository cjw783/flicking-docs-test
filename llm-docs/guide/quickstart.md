...
Flicking provides minimal base styles to give you maximum styling freedom. The required base CSS handles only functionality, not design. Learn about [HTML Structure & Styling](https://cjw783.github.io/flicking-docs-test/docs/structure-and-styling) to understand Flicking's architecture and how to style your carousel. This guide covers:
...
See [Flicking Methods](https://cjw783.github.io/flicking-docs-test/docs/api/classes/Flicking#methods) for all available methods.
...
See [React Guide](https://cjw783.github.io/flicking-docs-test/docs/react-guide) for more details.
...
See [Vue3 Guide](https://cjw783.github.io/flicking-docs-test/docs/vue3-guide) for more details.

  

See [Event Interfaces](https://cjw783.github.io/flicking-docs-test/docs/api/interfaces/ChangedEvent) for all available events.
...
- **[HTML Structure & Styling](https://cjw783.github.io/flicking-docs-test/docs/structure-and-styling)**: Understand Flicking's architecture and customize your carousel
- **Framework Guides** ([React](https://cjw783.github.io/flicking-docs-test/docs/react-guide) / [Vue3](https://cjw783.github.io/flicking-docs-test/docs/vue3-guide)): Framework-specific features and best practices
- **[Common Option Recipes](https://cjw783.github.io/flicking-docs-test/docs/option-recipes)**: Learn about option interactions and recommended patterns
- **[API Reference](https://cjw783.github.io/flicking-docs-test/docs/api/classes/Flicking)**: Complete API documentation
- **[Demos](https://cjw783.github.io/flicking-docs-test/docs/demos/basic/circular)**: Interactive examples
...
**Need more help?** Check [GitHub Issues](https://github.com/naver/egjs-flicking/issues) or read the [API documentation](https://cjw783.github.io/flicking-docs-test/docs/api/classes/Flicking)
